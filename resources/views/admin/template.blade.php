...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('/') }}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block text-danger">Doctor Appointment</span>
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Deparments</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('admin.create.deparment') }}">
                            <i class="bi bi-circle"></i><span>Create Deparment</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.deparment.list') }}">
                            <i class="bi bi-circle"></i><span>Deparment list</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#doctor" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Doctors</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="doctor" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('admin.doctor') }}">
                            <i class="bi bi-circle"></i><span>Create Doctors</span>
                        </a>
                    </li>
                    <li>
            ...
            {{-- doctor schedule --}}
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#schedule" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Schedule</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="schedule" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{route('admin.doctor.schedule')}}">
                            <i class="bi bi-circle"></i><span>Create Schedule</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.doctor.schedule.list')}}">
            ...
            {{-- patient appointment --}}
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#patient" data-bs-toggle="collapse"
                    href="#">
            ...
            {{-- admin --}}
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#admin" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Admins</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            {{-- contact --}}
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#contact" data-bs-toggle="collapse"
                    href="#">
    ...
    <footer id="footer" class="footer mt-5">
        <div class="copyright">
            &copy; Copyright <strong><span class="text-danger">Appointment Admin</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="https://bootstrapmade.com/"><strong><i class="text-danger">Thuyeain
                        Htun</i></strong></a>
        </div>
    </footer><!-- End Footer -->
